...
2인 1조가 팀이되어 각 인원의 타자 속도를 점수로 사용한다.
타자 연습 속도 측정은 한컴타자연습 사이트에서 진행한다.
장문 연습 난이도 100에서 한글/영어는 자유롭게 진행한다. (단, 한글의 경우 패널티를 부여한다.)
강사 김싸피도 참여하지만 순위에 포함되지는 않고, 학생들의 순위 결정 기준이 된다.
