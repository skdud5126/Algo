...
평탄화를 모두 수행하고 나면, 가장 높은 곳과 가장 낮은 곳의 차이가 최대 1. [가장 먼 노드] 이내가 된다.
...
2회의 덤프 후, 최고점과 최저점의 차이는 8 – 2 = 6 이 되었다 (최초덤프 이전에는 9 – 1. [가장 먼 노드] = 8 이었다).
...
for case in range(1, 11):
    N = int(input())  # 덤프 횟수
    data = list(map(int, input().split()))  # 상자 입력받음
    res = 1
