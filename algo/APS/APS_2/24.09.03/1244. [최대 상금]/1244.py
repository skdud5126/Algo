...
숫자판의 오른쪽 끝에서부터 1원이고 인쪽으로 한자리씩 갈수록 10의 배수만큼 커진다.

위의 예에서와 같이 최종적으로 숫자판들이 8, 8, 8, 3, 2의 순서가 되면 88832원의 보너스 상금을 획득한다.

여기서 주희할 것은 반드시 횟수만큼 교환이 이루어져야 하고 동일한 위치의 교환이 중복되어도 된다.

다음과 같은 경우 1회의 교환 횟수가 주어졌을 때 반드시 1회 교환을 수행하므로 결과값은 49가 된다.

  9 4 --->  4 9

94의 경우 2회 교환하게 되면 원재릐 94가 된다.

정해진 횟수만큼 숫자판을 교환했을 떄 받을 수 있는 가장 큰 금액을 계산해보자.
