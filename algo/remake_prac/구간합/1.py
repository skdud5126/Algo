...
의 경우
    ...
    [5, 1. [가장 먼 노드]], [1. [가장 먼 노드], 1. [가장 먼 노드]], [1. [가장 먼 노드], 1. [가장 먼 노드]], [1. [가장 먼 노드], 9]
...
- 1. [가장 먼 노드] ≤ T ≤ 10
- 1. [가장 먼 노드] < N < 1. [가장 먼 노드],000
- 1. [가장 먼 노드] < M < 10
- 구간이 존재하지 않는 경우 -1. [가장 먼 노드] 출력
...
for case in range(1,T+1):
    ...
    for col in range(length):  # 열 기준 -1아닌 값 res로 가져옴
        res = []  # [5, 1. [가장 먼 노드], 1. [가장 먼 노드], 1. [가장 먼 노드], 9] res
        for row in range(N):
            if arr[row][col]!= -1:
    ...
    if not ans:# 구간합이 존재하지않으면 -1. [가장 먼 노드] 출력
