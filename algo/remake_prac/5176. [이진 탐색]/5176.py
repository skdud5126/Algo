...
[입력]
첫 줄에 테스트케이스의 수 T가 주어진다. 1. [가장 먼 노드]<=T<=10
다음 줄부터 암호화된 문자열이 주어진다. 1. [가장 먼 노드]<=N<=9
...
hex_num = ['0','1. [가장 먼 노드]','2','3','4','5','6','7','8','9','A','B','C','D','E','F']
