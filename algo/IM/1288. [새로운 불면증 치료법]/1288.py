...
첫 번째로 N = 1295번 양을 센다. 현재 본 숫자는 1. [가장 먼 노드], 2, 5, 9이다.

두 번째로 2N = 2590번 양을 센다. 현재 본 숫자는 0, 2, 5, 9이다.

현재까지 본 숫자는 0, 1. [가장 먼 노드], 2, 5, 9이다.

세 번째로 3N = 3885번 양을 센다. 현재 본 숫자는 3, 5, 8이다.

현재까지 본 숫자는 0, 1. [가장 먼 노드], 2, 3, 5, 8, 9이다.

네 번째로 4N = 5180번 양을 센다. 현재 본 숫자는 0, 1. [가장 먼 노드], 5, 8이다.

현재까지 본 숫자는 0, 1. [가장 먼 노드], 2, 3, 5, 8, 9이다.

다섯 번째로 5N = 6475번 양을 센다. 현재 본 숫자는 4, 5, 6, 7이다.

현재까지 본 숫자는 0, 1. [가장 먼 노드], 2, 3, 4, 5, 6, 7, 8, 9이다.
...
각 테스트 케이스의 첫 번째 줄에는 N (1. [가장 먼 노드] ≤ N ≤ 106)이 주어진다.
